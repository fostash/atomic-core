...
//     */
//    public static List<IQuery.IColumn> getCreateBaseInfo() {
...
//     */
//    public static List<IQuery.IColumn> getUpdateBaseInfo() {
...
//     */
//    public static List<IQuery.IColumn> getDeleteBaseInfo() {
...
//     * @return base info for object logic deletion
//     */
//    public static List<IQuery.IColumn> getAllBaseInfo() {
//        return Stream.concat(
//                Stream.concat(getCreateBaseInfo().stream(), getUpdateBaseInfo().stream()),
//                getDeleteBaseInfo().stream()
